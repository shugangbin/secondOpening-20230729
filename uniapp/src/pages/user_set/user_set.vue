...
<!--                </view>-->
        ...
        <!-- 退出登录 -->
        <view
            class="item text-nr flex justify-center items-center mt-[10rpx] px-[30rpx] bg-white h-[100rpx]"
...
const handlePwd = () => {
    if (!userInfo.value.has_password)
        return router.navigateTo(
            '/pages/change_password/change_password?type=set'
        )
