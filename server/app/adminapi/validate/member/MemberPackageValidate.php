...
class MemberPackageValidate extends BaseValidate
{
    ...
    {
        return $this->only(['name','duration','sell_price','lineation_price','is_retrieve','retrieve_amount','sort','status','is_perpetual','chat_limit','benefits_ids','give_draw_number']);
    }
    ...
    {
        return $this->only(['id','name','duration','sell_price','lineation_price','is_retrieve','retrieve_amount','sort','status','is_perpetual','chat_limit','benefits_ids','give_draw_number']);
    }
