                        ...
                        <div class="mounted-content-item show">
                            ...
                            <div class="content">
                                ...
                                <div class="white-space;pre">
                                    版权所有(c)2023，AI应用研习社（公众号）团队保留所有权利。
                                </div>

                                <p class="mt16">
                                    感谢您信任并选择由AI应用研习社（公众号）团队开发的ChatAI智能聊天系统。为了正确并合法的使用本系统，请您在使用前务必阅读且理解下面的协议条款：
                                </p>

                                <h3 class="mt16">一、本授权协议适用于ChatAI智能聊天系统（源代码）（以下简称本系统）的任何版本，AI应用研习社（公众号）团队（以下简称我们）拥有本授权协议的最终解释权。</h3>
                            ...
                            <?php if ($step == '5') { ?>
                                <div class="show" id="mounting-success">
                                    ...
                                    <div class="success-content">
                                        ...
                                        <div style="margin-top: 5px;font-size:14px;">版本号：2.3.3</div>
                                        <div class="tips">
