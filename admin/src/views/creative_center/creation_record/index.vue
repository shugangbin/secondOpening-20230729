    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            >
                ...
                <el-table-column label="用户输入" prop="ask" min-width="280"> </el-table-column>
                <el-table-column label="审核状态">
                    <template #default="{ row }">
                        <div>
                            <el-tag class="ml-2" v-if="row.censor_status == 1" type="success">
                                {{ row.censor_status_desc }}
                            </el-tag>
                            <template v-else-if="row.censor_status >= 2">
                                <el-tag class="ml-2 cursor-pointer" type="danger">
                                    {{ row.censor_status_desc }}
                                </el-tag>
