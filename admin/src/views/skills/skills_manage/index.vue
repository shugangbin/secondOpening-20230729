    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table size="large" class="mt-4" v-loading="pager.loading" :data="pager.lists">
                <el-table-column label="分类名称" prop="sn" min-width="120" />
                <el-table-column label="问题数量" min-width="100"> </el-table-column>
                ...
                <el-table-column label="排序" prop="account" min-width="120" />
                <el-table-column label="创建时间" prop="mobile" min-width="100" />
