<template>
    <div class="h-full poster" :style="styles">
        <!-- <div class="w-full h-full" :class="content.default == 1
            ...
            "> -->
        <div class="w-full h-full poster-contain1 bg-[#BBBBBB]" :style="{
            backgroundImage:
                content.default == 2
            ...
            <div class="px-[20px] pt-[120px]">
                <div class="bg-white rounded-lg p-[15px]">
            ...
            <div class="px-[20px] pt-[10px]">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <img :src="appStore.getImageUrl(content.defaultAvatar)" alt=""
                            class="w-[60px] h-[60px] rounded-full" />
                        <div class="ml-[10px] text-[16px] text-white">
                            <div>李富贵</div>
                            <div v-if="content.showData == 1">{{ content.data }}</div>
                        </div>
                    </div>
                    <div>
                        <img src="@/assets/images/code.png" alt="" class="w-[100px] h-[100px]" />
                        <div class="text-white">长按识别二维码</div>
                    </div>
                </div>
            </div>
        </div>
